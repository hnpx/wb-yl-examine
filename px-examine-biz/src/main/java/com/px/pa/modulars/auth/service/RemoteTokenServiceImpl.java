...
public class RemoteTokenServiceImpl {
     ...
     * @return
     */
    public List<Map<String, Object>> getTokenList(Map<String, Object> map, String form) {
        ...
        List<Map<String, Object>> list = redisTemplate.opsForValue().multiGet(pages);
        Map<String, Map<String, Object>> resultMap = new HashMap<>();
        list.forEach(item -> {
            resultMap.put(item.get("username").toString(), item);
        });
